package com.example.user.gitsquare;
    ...
    private class Recycle_adapter extends RecyclerView.Adapter<Recycle_adapter.ViewHolder>{
        ...
        class ViewHolder extends RecyclerView.ViewHolder {
            ...
            ViewHolder(View iv) {
                ...
                linkTv = iv.findViewById(R.id.linktv);
                CountTv = iv.findViewById(R.id.counttv);
                ImageIv = iv.findViewById(R.id.circle);
        ...
        public void onBindViewHolder(ViewHolder vh, int position) {
            ...
            Glide.with(context).load(dadp.getImage()).into(vh.ImageIv);
        }
